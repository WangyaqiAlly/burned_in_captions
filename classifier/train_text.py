...
def main(_):
    ...
    train_images, train_labels = inputs(batch_size=FLAGS.batch_size,train=True,shuffle=True, num_epochs=None)
    test_images, test_labels = inputs(batch_size=FLAGS.batch_size,train=False,shuffle=True, num_epochs=None)
