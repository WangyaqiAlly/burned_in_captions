...
Data_File = './cifar10_50percent/orig_data1.npy'
Label_File = './cifar10_50percent/orig_label1.npy'
Scope_Prefix = 'Site1_50_'
Record_file = Scope_Prefix + 'record.txt'

class Train_site1(object):
    '''
    ...
    def generate_augment_train_batch(self, train_data, train_labels, train_batch_size,augment = False):
        '''
