...
#CUDA_VISIBLE_DEVICES=1 python test.py --name=node_central --batch_num=128 --epoch=200 --record_name=random_0 --init_mode=0 --random_rate=0.00
#cp $init_record ./record/random_0/
