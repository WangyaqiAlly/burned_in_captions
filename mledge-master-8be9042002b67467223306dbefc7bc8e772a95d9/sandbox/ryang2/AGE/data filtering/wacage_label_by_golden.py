# CUDA_VISIBLE_DEVICES='1' python wacage_label_by_golden.py
...
with tf.Session() as sess:
    ...
    for batch_num in xrange(60000):
        ...
        golden_label = np.argmax(l, axis=1)

        # np.save(Save_dir+'img'+('%06d' % batch_num), batch_data)
        np.save(Save_dir+'logits'+('%06d' % batch_num), golden_label)
