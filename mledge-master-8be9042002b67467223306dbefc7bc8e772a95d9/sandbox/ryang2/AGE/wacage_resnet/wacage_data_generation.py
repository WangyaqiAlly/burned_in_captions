# CUDA_VISIBLE_DEVICES='0' python wacage_data_generation.py
...
parser.add_argument('-d', '--model_path', type=str, default='./match21_1.0/model.ckpt-69999')
parser.add_argument('-s', '--save_path', type=str, default='./match21_1.0/data/')
...
with tf.Session() as session:
    ...
    generate_samples, _ = Generator(BATCH_SIZE, all_gen_labels)
    ...
    for i in xrange(60000):
        ...
        samples = session.run(generate_samples, feed_dict={all_gen_labels:gen_labels})
        samples = ((samples+1.)*(255./2)).astype('int32')
        np.save(Save_dir+'img'+('%06d' % i), samples)
        np.save(Save_dir+'logits'+('%06d' % i),gen_labels)
