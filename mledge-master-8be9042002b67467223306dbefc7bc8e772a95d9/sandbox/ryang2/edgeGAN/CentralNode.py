...
class CentralNode(object):
    ...
    def classifier(self):
        with tf.variable_scope("classifier"):
            e = tf.layers.conv2d(inputs=self.x, filters=num_units_per_layer, kernel_size=3,
                                 strides=1, activation=tf.nn.elu,
                                 padding='same')
            # print e
            e = tf.layers.conv2d(inputs=e, filters=num_units_per_layer, kernel_size=3,
                                 strides=1, activation=tf.nn.elu,
                                 padding='same')
            # print e
            e = tf.image.resize_bilinear(images=e, size=[14, 14])
            # print e
            e = tf.layers.conv2d(inputs=e, filters=2 * num_units_per_layer, kernel_size=3,
                                 strides=1, activation=tf.nn.elu,
                                 padding='same')
            # print e
            e = tf.layers.conv2d(inputs=e, filters=2 * num_units_per_layer, kernel_size=3,
            ...
            # print e
            e = tf.layers.conv2d(inputs=e, filters=3 * num_units_per_layer, kernel_size=3,
                                 strides=1, activation=tf.nn.elu,
                                 padding='same')
            # print e
            e = tf.layers.conv2d(inputs=e, filters=3 * num_units_per_layer, kernel_size=3,
            ...
            e = tf.layers.dense(inputs=e, units=10, activation=None)
            # print e
