...
parser.add_argument('--m', help='latent space dimensionality', default=64, type=int)
...
parser.add_argument('--model', help='output model', default='model.proto.ali.cifar')
...
def gaussianConditional(args, e_out):
	mu, log_sigma = e_out[:, :, :, :64], e_out[:, :, :, 64:]
