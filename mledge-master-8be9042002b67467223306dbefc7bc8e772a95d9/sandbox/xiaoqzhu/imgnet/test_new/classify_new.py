...
def load_train(traindir): 
	...
	for t in range(ntime): 
		...
		imglist = os.listdir(currpath) 
		for k in range(nsub):
		# for imgfile in os.listdir(currpath): 
		    # imgfile = '%s/%06d-32x32.jpg' % (currpath, k)
		    imgfile = os.path.join(currpath, imglist[k])
		    # print imgfile
...
'load data'
traindir = '/home/xiaoqzhu/dataset/imgnet-5-class-32x32/dataset-5-class-new/train'
validdir = '/home/xiaoqzhu/dataset/imgnet-5-class-32x32/dataset-5-class-new/validation'
...
with open('training_record_new.txt', 'w+') as f:
