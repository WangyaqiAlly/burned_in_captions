...
tf.app.flags.DEFINE_string('save_dir', "./Record/multisites/0_2500", "log_dir")
...
DATA_DIR = '../../../Data/cifar10_25percent/'    #file path to be modified
LABELED_DATA_DIR = '../../../Data/cifar_nozca/'    #file path to be modified
if len(DATA_DIR) == 0:
...
with tf.Session() as session:
    ...
    train_gen_lab, train_gen_unlab, dev_gen= lib.cifar10_multisites.load_semi(BATCH_SIZE, LABELED_DATA_DIR,DATA_DIR, labeled_size,Site_N)
    ...
    for iteration in xrange(ITERS):
        ...
        if iteration % 1000 == 999 or iteration == ITERS - 1:
            dev_disc_costs = []
            dev_disc_costs = []
            dev_disc_wgan = []
            dev_disc_acgan = []
            ...
            dev_disc_acgan_accs = []
            for _images_t, _labels_t in dev_gen():
                if CONDITIONAL and ACGAN:
