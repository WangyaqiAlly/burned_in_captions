...
tf.app.flags.DEFINE_string('unlabeled_data_path', '../Data/lsun20-tf-balance/',
                           'where to load the unlabeled dataset')
tf.app.flags.DEFINE_string('test_data_path', '../Data/lsun20-tf-balance/',
...
def inputs(batch_size=100,
    ...
    if train:
        ...
        filenames = sorted(glob.glob(os.path.join(FLAGS.test_data_path, 'lsun20_balance_site0_test.tfrecords')))
