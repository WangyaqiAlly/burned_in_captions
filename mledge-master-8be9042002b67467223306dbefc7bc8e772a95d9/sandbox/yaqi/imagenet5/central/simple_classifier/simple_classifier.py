...
tran_idx= random.sample(train_data,len(train_data).*0.8)


#### Read validation data
vali_data = np.load('./data/validation/balanced_images.npy')
vali_labels = np.load('./data/validation/balanced_labels.npy')
...
with open(tag + '/100_training_record.txt', 'w+') as f:
